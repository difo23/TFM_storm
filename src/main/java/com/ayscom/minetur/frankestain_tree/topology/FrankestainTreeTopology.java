...
import com.ayscom.minetur.frankestain_tree.bolts.FrankestainIM;
import com.ayscom.minetur.frankestain_tree.bolts.FrankestainSearchPM;
import com.ayscom.minetur.frankestain_tree.bolts.FrankestainSetInterval;
import com.ayscom.minetur.frankestain_tree.bolts.FrankestainTree;
...
//
  ...
  //Used to build the topology
   ...
   builder.setSpout("frank_spout", spout);
    ...
    builder.setBolt("franktree_bolt_1", new FrankestainTree()).shuffleGrouping("frank_spout","xdrs_spout");
    ...
    builder.setBolt("franksetint_bolt_2", new FrankestainSetInterval()).shuffleGrouping("franktree_bolt_1","franktree_bolt");

    builder.setBolt("franksearPM_bolt_3", new FrankestainSearchPM(), 1).shuffleGrouping("franksetint_bolt_2","frankSetInt_bolt");

    builder.setBolt("frankIM_bolt_4", new FrankestainIM(), 1).shuffleGrouping("franksearPM_bolt_3","franksearchpm_bolt");
/*
